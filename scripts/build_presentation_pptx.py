...
SLIDES = [
    ...
    },
    {
        ...
        "bullets": [
            "Problem and scope.",
            "Bright Data Twitter/X sample and larger 20M source.",
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Implemented: Bright Data CSV-to-stream adapter.",
    ...
    },
    {
        ...
        "presenter": "Presenter 1",
        "bullets": [
            "Default data: Bright Data Twitter/X posts sample.",
            "Source repo: luminati-io/Twitter-X-dataset-samples.",
            "Local demo replays 1000 public post rows.",
            "Fields include description, date, hashtags, engagement counts.",
            "Databricks Marketplace lists a larger 20M record dataset.",
        ],
    },
    {
        "title": "Data Adapter",
        "presenter": "Presenter 1",
        "bullets": [
            "data-generator/brightdata.py reads CSV URL or local CSV.",
            "description is tokenized with bert-base-multilingual-cased.",
            "date_posted becomes Unix timestamp.",
            "user, hashtag, media, and follower metadata are mapped.",
            "TOTAL_MESSAGES supports first 10, 100, 1000, or more rows.",
        ],
    },
    {
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Larger datasets reuse the same schema and batching boundary.",
        ],
    },
    {
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Future: use engagement counts, train ranking model, evaluate NDCG.",
